...
### [2] [Machine Learning and Deep Learning for Exoplanet Detection and Atmospheric Characterization with JWST and the Upcoming Ariel Mission](https://arxiv.org/abs/2606.23766)
...
### [3] [Astrobiology in the Time of Artificial Intelligence](https://arxiv.org/abs/2606.23854)
*Caleb Scharf*
...
### [4] [Stochastic Expectation Maximization for Robust State-Space Radio Interferometric Imaging](https://arxiv.org/abs/2606.23944)
...
### [5] [On-orbit Calibration of the Carruthers GCI: Photon Background Removal](https://arxiv.org/abs/2606.24030)
...
### [6] [Improving Radio Source Count Estimation Using Kernel Density Estimation](https://arxiv.org/abs/2606.24117)
...
### [7] [Widefield Spectroscopic Telescope (WST): coating strategy to achieve high optical throughput](https://arxiv.org/abs/2606.24179)
...
### [8] [White paper on the relevance of the European Solar Telescope (EST) for the French heliophysics](https://arxiv.org/abs/2606.24354)
...
### [9] [The Space Debris Tracking and Surveillance program of the IAC80 telescope](https://arxiv.org/abs/2606.24413)
*Olga Zamora*
...
### [10] [The Impact of Host Galaxy Properties on Supernova Classification with Hierarchical Labels](https://arxiv.org/abs/2606.24807)
...
### [11] [Modern tidal interaction models for rapid binary population synthesis: II. Binary black hole formation, mergers, and spins](https://arxiv.org/abs/2606.23773)
...
### [12] [Signatures of $^{56}$Ni Mixing and Neutron-rich Ejecta in Supernovae](https://arxiv.org/abs/2606.23780)
*Nikhil Sarin*
...
### [13] [First Results from the LSST Shadow Survey: The Restless Luminous Blue Variable AT2017des in the Virgo-Cluster Galaxy, NGC4532](https://arxiv.org/abs/2606.23784)
...
### [14] [A Collapsar-Disk Origin for GW190814](https://arxiv.org/abs/2606.23786)
...
### [15] [Composition of Radiation-Driven Winds from Type I X-ray Bursts](https://arxiv.org/abs/2606.23818)
...
### [16] [Indication for Decreasing Dispersion Measure in the Population of Repeating Fast Radio Bursts and Connection to Young Supernova Remnant Expansion](https://arxiv.org/abs/2606.23903)
...
### [17] [Deep Newtonian Afterglows: Theoretical Light Curves for Quasi-spherical Outflows](https://arxiv.org/abs/2606.23904)
...
### [18] [Detection of relativistic orbital deformation from improved timing of PSR J1757$-$1854](https://arxiv.org/abs/2606.23926)
...
### [19] [FAST Pulsar Database IV. Spike subpulses and quasi-periodic subpulses of 25 pulsars observed by FAST](https://arxiv.org/abs/2606.23970)
...
### [20] [Radio eclipse of the slowest spinning Galactic-field spider pulsar PSR J1932+2121 and its X-ray emission prospect](https://arxiv.org/abs/2606.24069)
...
### [21] [EP251023a: A fast X-ray transient featuring a magnetar-powered optical internal plateau followed by a steep decay](https://arxiv.org/abs/2606.24329)
...
### [22] [Asteroseismology of neutron stars with both hyperons and $Δ$ resonances](https://arxiv.org/abs/2606.24343)
...
### [23] [Magnetized Coulomb crystals in neutron star crusts](https://arxiv.org/abs/2606.24355)
...
### [24] [Probing Merger Shocks in Galaxy Clusters in the SKA Era](https://arxiv.org/abs/2606.24738)
...
### [25] [Interplay of Holographic and New Agegraphic Dark Energy in Cosmology: A hybrid dark energy model from a generalized length-time cut-off](https://arxiv.org/abs/2606.23728)
...
### [26] [Potentially healthy time evolution in interacting $p$-form fields](https://arxiv.org/abs/2606.23731)
...
### [27] [Removing Ostrogradsky modes in multi-field higher-order scalar-tensor theories](https://arxiv.org/abs/2606.23734)
...
### [28] [Physical properties of charged black holes from the nonlinear electrodynamics model based on electric potential regularization](https://arxiv.org/abs/2606.23746)
...
### [29] [EGUP effects on the thermodynamic properties of the Kerr-Newman black hole surrounded by quintessence](https://arxiv.org/abs/2606.23756)
...
### [30] [New Rotating Black Hole in Electromagnetic Fields: Cosmological Horizon without Cosmological Constant](https://arxiv.org/abs/2606.23782)
*Liang Ma,H. Lu*
...
### [31] [Black Hole Ringdown Nonlinearities in the Large-D Limit](https://arxiv.org/abs/2606.23804)
...
### [32] [A thorough investigation of cross-correlation estimators for stochastic gravitational-wave background searches in ground-based detector data](https://arxiv.org/abs/2606.23816)
...
### [33] [Primordial Black Holes: A Review of Formation and Evolution](https://arxiv.org/abs/2606.23846)
...
### [34] [Energy Extraction via Magnetic Reconnection from a Rotating Dyonic Black Hole in $N = 2, \ U(1)^2$ Gauged Supergravity](https://arxiv.org/abs/2606.23862)
...
### [35] [Newtonian Shirokov Effect: Epicyclic Frequency Splitting from Mass Multipoles](https://arxiv.org/abs/2606.23912)
...
### [36] [Nonrotating and rotating black holes with secondary disformal hair in a ghost-free metric-affine parity-violating scalar-torsion theory](https://arxiv.org/abs/2606.24041)
...
### [37] [Nanohertz gravitational waves from domain walls nucleated during inflation](https://arxiv.org/abs/2606.24070)
...
### [38] [Nonlinear Stability of Kerr-Sen Black Holes in Merging Binaries](https://arxiv.org/abs/2606.24215)
...
### [39] [Low-mass X-ray binaries as a probe of Kerr-MOG black hole spacetime](https://arxiv.org/abs/2606.24258)
...
### [40] [Thin accretion disks around a Schwarzschild acoustic black hole](https://arxiv.org/abs/2606.24315)
...
### [41] [Fermionic Love number of higher-dimensional Reissner-Nordström black holes](https://arxiv.org/abs/2606.24365)
...
### [42] [On Deformed Phase Space Black Holes](https://arxiv.org/abs/2606.24419)
...
### [43] [Binary black hole scattering with generic spins](https://arxiv.org/abs/2606.24432)
...
### [44] [Gravity theory of the generalized mass to horizon entropy The Iyer Wald approach](https://arxiv.org/abs/2606.24495)
...
### [45] [Strong field lensing and shadows of $\boldsymbol{f(Q,\mathcal{B})}$ gravity black holes](https://arxiv.org/abs/2606.24544)
...
### [46] [The $ω$-Effect from a Multimode Squeezed Graviton State](https://arxiv.org/abs/2606.24613)
...
### [47] [When Black Holes Can Wear Pants](https://arxiv.org/abs/2606.24642)
...
### [48] [Reduction of the Finsler gravity vacuum equation and dynamics for the cosmological Landsberg spacetimes](https://arxiv.org/abs/2606.24698)
...
### [49] [Radial Mirror Scattering and the QNM Convergence Region](https://arxiv.org/abs/2606.24812)
...
### [50] [The Bondi--Sachs gauge, BMS frames, and memory in black hole perturbation theory](https://arxiv.org/abs/2606.24816)
...
### [51] [Quintic Modification to Lifshitz Quasi-topological Black Holes](https://arxiv.org/abs/2606.24835)
...
### [52] [Non-perturbative, background independent Fock representations for canonical quantum gravity](https://arxiv.org/abs/2606.24858)
*T. Thiemann*
