...
### [1] [Assessing the Predictability of $δ$ Scuti Variable Stars for Spacecraft Navigation](https://arxiv.org/abs/2606.30691)
...
### [2] [Mapping Stellar Heterogeneities with the Nautilus Space Observatory](https://arxiv.org/abs/2606.30706)
...
### [3] [SHARP -- A spectrograph proposal to fully exploit ELT capabilities and look beyond JWST](https://arxiv.org/abs/2606.30721)
...
### [4] [Deep Learning for Astrophysics: An Open Textbook from the NASA Cosmic Origins AI/ML Science and Technology Interest Group](https://arxiv.org/abs/2606.30855)
...
### [5] [SHARPing accretion and outflows in young stellar objects in star forming regions of the outer Galaxy and beyond](https://arxiv.org/abs/2606.30867)
...
### [6] [SAOImageDS9: An Essential Tool for Astronomical Exploration](https://arxiv.org/abs/2606.30897)
...
### [7] [Combining a Diffraction-Limited Coronagraph with Fiber Nulling: A Demonstration of Serially Coupling Different Nullers](https://arxiv.org/abs/2606.31336)
...
### [8] [Multi-Scale Contrastive Attention for Light-Curve Representation Learning](https://arxiv.org/abs/2606.31627)
...
### [9] [Robust CMB polarisation mapmaking with a rotating half-wave plate](https://arxiv.org/abs/2606.31720)
...
### [10] [Focal Plate Prototyping for Modular Focal Planes of Stage-5 Instruments For Ground-Based Telescopes](https://arxiv.org/abs/2606.31727)
...
### [11] [Setting requirements on out-of-band rejection for next-generation CMB experiments. Application to the LiteBIRD instrument](https://arxiv.org/abs/2606.31778)
...
### [12] [Laser-based metrology systems vs wavefront sensing techniques: a comparative overview between the Large Binocular Telescope and the Vera C. Rubin Observatory for the telescope alignment and collimation tracking](https://arxiv.org/abs/2606.31792)
...
### [13] [Modeling of the diffuse background produced by the Vera C. Rubin Observatory M2 baffle scattered light](https://arxiv.org/abs/2606.31793)
...
### [14] [Test Management and Coordination During the Vera C. Rubin Observatory Commissioning and Early Operations Using Zephyr Scale](https://arxiv.org/abs/2606.31795)
...
### [15] [The On-Sky Performance of the LSST Camera CCD Array](https://arxiv.org/abs/2606.31806)
...
### [16] [In Situ Measurements of the Reflectances of the LSSTCam Optics and Assessing the Impact of Optical Ghosts](https://arxiv.org/abs/2606.31826)
...
### [17] [Determining stress-based bending mode limits for the Vera C. Rubin Observatory M1M3 active mirror system](https://arxiv.org/abs/2606.31849)
...
### [18] [Investigation and Mitigation of a Prominent Off-Axis Stray Light Path in Rubin Observatory Commissioning](https://arxiv.org/abs/2606.31939)
...
### [19] [An overview of stray light findings and interpretation during on-sky commissioning of LSSTCam](https://arxiv.org/abs/2606.31945)
...
### [20] [The filter exchange system of the LSSTCam at the Vera C. Rubin Observatory](https://arxiv.org/abs/2606.31995)
...
### [21] [Prospects for Improving the Theoretical Uncertainty for Tests of General Relativity with the EHT](https://arxiv.org/abs/2606.30753)
...
### [22] [Active Galactic Nuclei as high-energy neutrino sources](https://arxiv.org/abs/2606.30764)
*Filippo D'Ammando*
...
### [23] [NLTE Spectral Modelling of the Nearby Stripped-Envelope Supernova 2024ehs](https://arxiv.org/abs/2606.30796)
...
### [24] [Magnetar Formation from Accretion Induced Collapse of White Dwarfs](https://arxiv.org/abs/2606.30839)
...
### [25] [Multipolar Magnetic-Field Inference for PSR J0740+6620 with Neural-Network-Accelerated NICER Pulse-Profile Modeling](https://arxiv.org/abs/2606.30886)
...
### [26] [Energy-Resolved Limits on Orbital X-ray Polarization Modulation in Cygnus X-1](https://arxiv.org/abs/2606.30894)
...
### [27] [SN 2023rve: A Type II Supernova with No Nebular Oxygen](https://arxiv.org/abs/2606.30979)
...
### [28] [A New Relativistic Model for Spectral Formation in Accretion-Powered X-ray Pulsars: Pulse Profiles and Phase-Averaged Spectra](https://arxiv.org/abs/2606.30990)
...
### [29] [Photoionization of the Composite Nebula Surrounding NGC 5408 X-1: Implications for Beamed Emission](https://arxiv.org/abs/2606.31111)
...
### [30] [JWST Medium-Resolution Infrared Spectroscopy of SN 2022acko: Tracing Molecule Formation in the Nebular Phase](https://arxiv.org/abs/2606.31176)
...
### [31] [Multi-band power color-color diagrams of three black hole X-ray binaries observed with Insight-HXMT](https://arxiv.org/abs/2606.31289)
...
### [32] [Estimation of black hole spins in low-mass AGNs and comparison with other types of AGNs](https://arxiv.org/abs/2606.31436)
...
### [33] [Scattering of Strong Radio Waves by Particles in Strongly Magnetized Plasmas and Implications for Fast Radio Bursts](https://arxiv.org/abs/2606.31439)
...
### [34] [Multi-wavelength Emission Modeling from Accretion Flows around Isolated Black Holes Including Magnetic Flux Transport](https://arxiv.org/abs/2606.31477)
...
### [35] [Magnetic field and plasma number density from radio and millimeter core measurements in AGN jets](https://arxiv.org/abs/2606.31510)
...
### [36] [Unveiling Radio Transients with SKAO Telescopes](https://arxiv.org/abs/2606.31701)
...
### [37] [The location of the upper edge of the pair-instability supernovae black hole mass gap](https://arxiv.org/abs/2606.31757)
...
### [38] [Evidence for Millihertz Oscillations in the bright atoll source GX 3+1](https://arxiv.org/abs/2606.31798)
...
### [39] [High Frequency Wideband Study of FRB 20240114A with the Allen Telescope Array](https://arxiv.org/abs/2606.31897)
...
### [40] [Radiation-pressure instability is an artifact of constant-$α$ closure](https://arxiv.org/abs/2606.31998)
...
### [41] [Dynamical Completion of Coupling-Charge Thermodynamics](https://arxiv.org/abs/2606.30707)
...
### [42] [Ray tracing ultracompact boson stars: visibility modulations and incomplete photon rings](https://arxiv.org/abs/2606.30729)
...
### [43] [Black holes in a bouncing universe](https://arxiv.org/abs/2606.30818)
...
### [44] [Scalarization and descalarization in hyperbolic encounters of black holes](https://arxiv.org/abs/2606.30865)
...
### [45] [A rotating black hole in a Hernquist dark matter halo: horizon geometry, thermodynamics, and quantum emission](https://arxiv.org/abs/2606.30962)
...
### [46] [Repetitive Penrose process for charged particles in Kerr-Newman black holes](https://arxiv.org/abs/2606.30969)
...
### [47] [Phase space quantization of anisotropic cosmologies: Taub and Kantowski-Sachs models](https://arxiv.org/abs/2606.31049)
...
### [48] [Geometric formulation for Palatini-Cartan gravity](https://arxiv.org/abs/2606.31070)
...
### [49] [Stability of the Minkowski spacetime in Newman-Unti gauge](https://arxiv.org/abs/2606.31090)
