...
### [3] [Cosmological perturbations and gravitational waves in the general Einstein-vector theory](https://arxiv.org/abs/2602.12536)
...
### [4] [Dynamical system and statefinder analysis of cosmological models in f(T, B) gravity](https://arxiv.org/abs/2602.12728)
...
### [5] [Statistics of time and frequency-averaged spectra in gravitational-wave background searches](https://arxiv.org/abs/2602.12781)
...
### [6] [New Horizons in Effective Field Theory?](https://arxiv.org/abs/2602.12802)
...
### [7] [Are black hole spins truly near-zero?](https://arxiv.org/abs/2602.12859)
...
### [8] [Scalar field coupled to boundary in non-metricity: a new avenue towards dark energy](https://arxiv.org/abs/2602.12981)
...
### [9] [Evolution of Linear Perturbations under Time-Dependent Hubble Friction I: SR-USR-SR Inflation](https://arxiv.org/abs/2602.13074)
*Wen Li,Chao Chen*
...
### [10] [Unraveling the Origin of Unequal Mass Gravitational Wave Events: Insights from a Galactic High Mass X-ray Binary](https://arxiv.org/abs/2602.12327)
...
### [11] [Precursors in tidal disruption events: repeating, fast, and AGN-hosted TDEs](https://arxiv.org/abs/2602.12355)
*Patrik Milán Veres*
...
### [12] [First-Principles Polar-Cap Currents in Multipolar Pulsar Magnetospheres](https://arxiv.org/abs/2602.12376)
*Chun Huang*
...
### [13] [The Role of Faraday Rotation in the Polarization of the X-rays from Magnetically Powered Black Hole Coronas](https://arxiv.org/abs/2602.12411)
*Henric Krawczynski*
...
### [14] [Broadband Timing and Spectral Study of Accreting Millisecond X-ray Pulsar SAX J1808.4$-$3658 during Its 2022 Outburst](https://arxiv.org/abs/2602.12425)
...
### [15] [Correlated and uncorrelated Monte Carlo neutron capture rate variations in weak $\textit{r}$-process simulations](https://arxiv.org/abs/2602.12428)
...
### [16] [Ballistic Surfing Acceleration as a Coherent Mechanism for Electron Acceleration in Galaxy Cluster Shocks](https://arxiv.org/abs/2602.12647)
...
### [17] [Constraints on GRB Jet Properties from IceCube Upper Limits: Insights from GRB 221009A and GRB 240825A](https://arxiv.org/abs/2602.12837)
...
### [20] [Astrophysics Wrapped 2025: Year-in-Review of Every Astrophysics arXiv Paper from 2025](https://arxiv.org/abs/2602.12303)
...
### [21] [GAMERA-OP: A three-dimensional finite-volume MHD solver for orthogonal curvilinear geometries](https://arxiv.org/abs/2602.12307)
...
### [22] [New Time-Dependent WFC3/IR Inverse Sensitivities](https://arxiv.org/abs/2602.12367)
...
### [23] [Murriyang cryogenic phased array feed: spectral-line results and noise-reduction methods](https://arxiv.org/abs/2602.12677)
...
### [24] [ESO White Paper on Intensity Interferometry: Cosmology, Fundamental Physics, Quantum Optics](https://arxiv.org/abs/2602.12717)
...
### [25] [CHIME/Slow overview and pilot survey: A new backend to search for second-duration radio transients with the CHIME telescope](https://arxiv.org/abs/2602.12793)
...
### [26] [Observations of Binary Stars with the 1.3-m Devasthal Fast Optical Telescope Using Speckle Interferometry: An Attempt](https://arxiv.org/abs/2602.12907)
...
### [27] [Statements of Current States of the Art for Key non-Coronagraphic Technologies for HWO](https://arxiv.org/abs/2602.12995)
...
### [28] [Photometric classification of supernovae detected by the Zwicky Transient Facility using noise augmentation](https://arxiv.org/abs/2602.13036)
