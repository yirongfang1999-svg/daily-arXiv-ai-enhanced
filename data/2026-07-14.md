...
### [38] [Robust Photometry for Roman High-Latitude Imaging Survey Cosmology Using Roman and Rubin Imaging](https://arxiv.org/abs/2607.09849)
...
### [39] [Efficient Optimal Image Reconstruction for the Nancy Grace Roman Space Telescope and Beyond: II. Implementation of {\sc Effortless}](https://arxiv.org/abs/2607.09862)
*Kaili Cao*
...
### [40] [Neural Posterior Estimation for Inferring Weak Lensing Shear](https://arxiv.org/abs/2607.09867)
...
### [41] [LISA 10 -- Library and Information Services in Astronomy. Report on the ESO workshop](https://arxiv.org/abs/2607.09870)
...
### [42] [SAXO+, the second-stage adaptive optics for SPHERE: NCPA compensation and dark-hole loop with a pyramid wavefront sensor](https://arxiv.org/abs/2607.10124)
...
### [43] [Exoplanetary Tour Design with Solar Sails: TheAntipodes Results in the GTOC13 Problem](https://arxiv.org/abs/2607.10150)
...
### [44] [Detector-level simulation closure of radio air-shower reconstruction with fixed equal-prior geomagnetic templates](https://arxiv.org/abs/2607.10637)
...
### [45] [GroundBIRD: First On-Sky Responsivity Calibration at the Teide Observatory](https://arxiv.org/abs/2607.10845)
...
### [46] [Fast(er)PM and Moving Mesh: JAX-native Geometric Multigrid Methods](https://arxiv.org/abs/2607.10983)
*Benjamin Horowitz*
...
### [47] [Synthesis imaging with a lunar orbit array: III. Augmented lagrangian Multiplier Imaging using Gradient descent Optimization (AMIGO)](https://arxiv.org/abs/2607.11006)
...
### [48] [Low-Noise SiPM Light Readout and ASIC-Based Charge Readout of a Liquid Argon Time Projection Chamber for MeV Gamma-Ray Measurements](https://arxiv.org/abs/2607.11336)
...
### [49] [WALOP-South: a four camera one shot imaging polarimeter for the PASIPHAE survey. Paper III -- PSF modelling](https://arxiv.org/abs/2607.11825)
...
### [50] [Ardua: Unveiling the Baryon Cycle from Stars to the Cosmic Web](https://arxiv.org/abs/2607.11865)
...
### [51] [Low-hard to high-soft spectral state transitions in the faintest early-X-ray-detected optical tidal disruption event TDE 2025aarm](https://arxiv.org/abs/2607.09850)
...
### [52] [The Radio Properties of Extreme Coronal Line Emitters: Constraints on the Sub-parsec Environment](https://arxiv.org/abs/2607.09871)
...
### [53] [A new likely pulsar binary in 47~Tucanae from continuum searches](https://arxiv.org/abs/2607.09958)
...
### [54] [A spectacular multi-wavelength transient associated with an off-axis relativistic jet](https://arxiv.org/abs/2607.10047)
...
### [55] [Intrinsic Spectral Curvature from Finite-Cycle Transport at Relativistic Shocks](https://arxiv.org/abs/2607.10060)
*Ji-Hoon Ha*
...
### [56] [Gaussian-process evidence for a stochastic-variability transition in the recovering corona of 1ES 1927+654](https://arxiv.org/abs/2607.10167)
...
### [57] [Magnetospheric flows in X-ray pulsars II: Heating, cooling and ionization degree at sub-critical accretion](https://arxiv.org/abs/2607.10342)
...
### [58] [Strongly interacting matter with criticality induced by modified excluded volume in core-collapse supernova simulations](https://arxiv.org/abs/2607.10396)
...
### [59] [Fermi-Large Area Telescope Detection of Very High Energy (>100 GeV) Emission from Compton-Dominated Blazars](https://arxiv.org/abs/2607.10407)
...
### [60] [Inhibition of Accretion by the Stellar Wind in Misaligned Be/X-ray Binaries](https://arxiv.org/abs/2607.10568)
*Atsuo T. Okazaki*
...
### [61] [Wind-driven angular momentum removal and X-ray ionization effects in Roche-lobe overflowing HMXBs](https://arxiv.org/abs/2607.10579)
...
### [62] [Late-time emission-line profiles from kilonova models](https://arxiv.org/abs/2607.10818)
...
### [63] [Determination of neutron star radius from pulse profile modeling using profile likelihood](https://arxiv.org/abs/2607.11154)
...
### [64] [Search for GeV gamma-ray emission from PSZ G181.06+48.47 galaxy cluster using Fermi-LAT data](https://arxiv.org/abs/2607.11316)
...
### [65] [Two Earliest Optical-UV Tidal Disruption Events Hidden in the SDSS DR7 Catalog Unveiled by the Transformer-Based Spectrum Classifier](https://arxiv.org/abs/2607.11539)
...
### [66] [Chandra and XMM-Newton X-ray Study on the Core-collapse Supernova Remnant N63A in an H II Region](https://arxiv.org/abs/2607.11324)
...
### [67] [Synchrotron radiation in nonuniform magnetic field](https://arxiv.org/abs/2607.11402)
...
### [68] [Cosmic-ray anisotropy: sensitivity of methods and implications for KASCADE data](https://arxiv.org/abs/2607.11405)
...
### [69] [Probing radiation micro-physics in M 87 I. Total intensity and broad-band spectra](https://arxiv.org/abs/2607.11439)
...
### [70] [Discovering Millisecond Pulsars in Globular Clusters with the GMRT (GCGPS)](https://arxiv.org/abs/2607.11461)
...
### [71] [Superdiffusion of cosmic rays in the vicinity of their accelerators and the resulting $γ$-ray emission](https://arxiv.org/abs/2607.11485)
...
### [72] [AT2019ijn: a fast-rising, slow-decaying blue optical transient with exceptionally bright radio emission](https://arxiv.org/abs/2607.11545)
...
### [73] [Radio and X-ray flux rebrightening six years after outburst in a partially-obscured extreme changing-look AGN](https://arxiv.org/abs/2607.11546)
...
### [74] [Extending the infrastructure of the BAM code towards resistive general-relativistic magnetohydrodynamics: tests and first applications](https://arxiv.org/abs/2607.11670)
...
### [75] [Tidal deformation and strain accumulation of solid compact stars](https://arxiv.org/abs/2607.11780)
...
### [76] [HAMCOR: A physics-driven Hamiltonian framework for inferring AGN coronal geometry from X-ray reverberation lags](https://arxiv.org/abs/2607.11805)
*Buffoli Fabio*
