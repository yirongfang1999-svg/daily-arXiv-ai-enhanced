...
### [2] [Design and characterization of W-band and D-band calibration sources for the AliCPT-1 experiment](https://arxiv.org/abs/2602.11620)
...
### [3] [Beyond One-Thousandth Energy Resolution with an AlMn TES Detector](https://arxiv.org/abs/2602.11728)
...
### [4] [Testing and Validation of the Updated Pixel-Based Non-Linearity Calibration File for WFC3/IR](https://arxiv.org/abs/2602.12110)
...
### [5] [aurel: A Python package for automatic relativistic calculations](https://arxiv.org/abs/2602.00155)
...
### [7] [A Nonlinear Endpoint of Charged Horizon Instabilities](https://arxiv.org/abs/2602.11256)
...
### [8] [Dynamical systems approach to stellar modelling in $f(G, B)$ gravity](https://arxiv.org/abs/2602.11297)
...
### [9] [Generalized entropic uncertainty relation and non-classicality in Schwarzschild black hole](https://arxiv.org/abs/2602.11503)
...
### [10] [Precessions and parameter constraints from quasiperiodic oscillations in a rotating charged black hole](https://arxiv.org/abs/2602.11525)
...
### [11] [Complete freezing of initially maximal entanglement in Schwarzschild black hole](https://arxiv.org/abs/2602.11586)
...
### [12] [On the numerical evaluation of the `exact' Post-Newtonian parameters in Brans-Dicke and Entangled Relativity theories](https://arxiv.org/abs/2602.11811)
...
### [13] [Black holes in effective loop quantum gravity: Hawking radiation](https://arxiv.org/abs/2602.11828)
...
### [14] [pespace: A new tool of GPU-accelerated and auto-differentiable response generation and likelihood evaluation for space-borne gravitational wave detectors](https://arxiv.org/abs/2602.12011)
...
### [15] [A unified framework for photon and massive particle hypersurfaces in stationary spacetimes](https://arxiv.org/abs/2602.11883)
...
### [16] [Bosonic and fermionic statistics in nonperturbative quantum gravity](https://arxiv.org/abs/2602.11927)
...
### [17] [Dark matter distributions around extreme mass ratio inspirals: effects of radial pressure and relativistic treatment](https://arxiv.org/abs/2602.12022)
...
### [18] [Primordial Black Hole Formation in Dust-Radiation Bouncing Cosmologies](https://arxiv.org/abs/2602.12057)
...
### [19] [Cosmographic Connection Between Cosmological And Planck Scales: The Barrow-Tsallis Entropy](https://arxiv.org/abs/2602.12077)
...
### [20] [Black Holes Trapped by Ghosts](https://arxiv.org/abs/2602.12101)
...
### [21] [Spin networks of quantum channels](https://arxiv.org/abs/2602.12145)
...
### [22] [What does a regular star look like?](https://arxiv.org/abs/2602.12200)
...
### [23] [3D insights into SN 1987A: ALMA observations compared to hydrodynamical explosion simulations](https://arxiv.org/abs/2602.11259)
...
### [24] [Evolution of the transitional millisecond pulsar PSR J1023+0038 from Aqueye+ and NICER observations](https://arxiv.org/abs/2602.11274)
...
### [25] [Measurement prospects for the pair-instability mass cutoff with gravitational waves](https://arxiv.org/abs/2602.11282)
...
### [26] [Unification Model of Active Galactic Nuclei by Photoionization Equilibrium Calculation Based on Radiative Hydrodynamic Simulations](https://arxiv.org/abs/2602.11474)
...
### [27] [Searching for Anisotropy in the Gravitational Wave Background Using the Parkes Pulsar Timing Array](https://arxiv.org/abs/2602.11529)
...
### [28] [Understanding coronal geometry in NGC 4593 using Fourier frequency-resolved covariance and time-lag spectral analysis](https://arxiv.org/abs/2602.11624)
...
### [29] [Population synthesis predictions of the Galactic compact binary gravitational wave foreground detectable by LISA](https://arxiv.org/abs/2602.11765)
...
### [30] [Impact of crust-core connection procedures on the tidal deformability of neutron stars](https://arxiv.org/abs/2602.11809)
...
### [31] [Monitoring the upper atmospheric temperature and interplanetary magnetic field with the GRAPES-3 muon telescope](https://arxiv.org/abs/2602.11847)
...
### [32] [Spectro-timing origin of large amplitude X-ray variability in GRS 1915+105 using AstroSat/LAXPC and SXT](https://arxiv.org/abs/2602.11876)
...
### [33] [The Interstellar Scintillation of the Radio-Loud Magnetar XTE J1810-197](https://arxiv.org/abs/2602.12051)
...
### [34] [Search for Sub-Solar Mass Binaries in the First Part of LIGO's Fourth Observing Run](https://arxiv.org/abs/2602.12115)
...
### [35] [Poloidal Field Amplification through Compression-Shear Dynamics in Schwarzschild Accretion: Pathways to MAD States](https://arxiv.org/abs/2602.12165)
...
### [36] [A simple model for extracting astrophysics from black hole images](https://arxiv.org/abs/2602.12195)
...
### [37] [The Wandering Supermassive Black Hole Powering the off-nuclear TDE AT2024tvd](https://arxiv.org/abs/2602.12272)
...
### [38] [Ubiquitous yet forgotten: broad absorptions in the optical spectra of low-mass X-ray binaries](https://arxiv.org/abs/2602.12282)
