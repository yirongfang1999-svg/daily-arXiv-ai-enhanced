...
### [14] [Patch-Level DINOv2 Scoring for Gravitational-Wave Glitch Detection: Breaking the Signal Dilution Barrier via Vector-Quantized Local Feature Indexing](https://arxiv.org/abs/2606.09933)
*Luca Cirfeta*
...
### [15] [Commissioning of the Vera C. Rubin Observatory and Weak Gravitational Lensing](https://arxiv.org/abs/2606.09938)
...
### [16] [Flux-cube reconstruction from slitless spectroscopy](https://arxiv.org/abs/2606.09974)
...
### [17] [Method to get Better Sky Maps in a GstLAL Low-Latency Analysis](https://arxiv.org/abs/2606.10076)
...
### [18] [Exploring Exoplanets with Interferometry](https://arxiv.org/abs/2606.10108)
...
### [19] [Exploring the Orbital Stability of Large, Lightweight Mirrors around Exoplanets](https://arxiv.org/abs/2606.10140)
...
### [20] [The Case for High-Resolution Infrared Spectroscopy with the Habitable Worlds Observatory](https://arxiv.org/abs/2606.10171)
...
### [21] [DIffuse X-ray Explorer (DIXE): Sky Survey Strategy and Collimator Response Demodulation](https://arxiv.org/abs/2606.10712)
...
### [22] [UnReal-B : Real-Space DFT Solver for Matter in Extreme Magnetic Fields](https://arxiv.org/abs/2606.10750)
...
### [23] [SUPPPPRESS: Prototyping and testing liquid-crystal vector vortex coronagraphs with reduced polarization leakage](https://arxiv.org/abs/2606.10760)
...
### [24] [On-sky demonstration of reinforcement learning for adaptive optics control](https://arxiv.org/abs/2606.10771)
...
### [25] [A data-driven method for measuring corner-clipping probabilities in segmented particle detectors](https://arxiv.org/abs/2606.11097)
...
### [26] [The Ohio SETI Program -- The Last Decades](https://arxiv.org/abs/2606.11102)
...
### [27] [Modelling the Dynamics of Middle-Aged Pulsar Wind Nebulae in the Reverberation Phase](https://arxiv.org/abs/2606.09914)
...
### [28] [The Curious Case of PHL 1811: Heavy Obscuration Versus Intrinsic X-ray Weakness](https://arxiv.org/abs/2606.09981)
...
### [29] [EP260321a/SN 2026gzf: The Faintest Shock Breakout Associated with a Broad-Lined Supernova](https://arxiv.org/abs/2606.09992)
...
### [30] [Failed jet breakout in the metal-poor broad-lined type Ic supernova 2026gzf](https://arxiv.org/abs/2606.10002)
...
### [31] [Decadal pre-explosion activity and circumstellar interaction in a supernova](https://arxiv.org/abs/2606.10009)
...
### [32] [A Multi-Wavelength View of the First Type Ic-BL Supernova with an Einstein Probe X-ray Shock Breakout](https://arxiv.org/abs/2606.10011)
...
### [33] [Limits on primordial black holes from the extragalactic gamma-ray background; current status and future projections](https://arxiv.org/abs/2606.10013)
...
### [34] [Thermal X-rays breaking out from pre-explosion ejecta of a dying massive star](https://arxiv.org/abs/2606.10014)
...
### [35] [Refined anti-proton and anti-deuteron fluxes from weak-scale Dark Matter](https://arxiv.org/abs/2606.10017)
...
### [36] [Internal constitution of the outer crust of non-accreted neutron stars and magnetars](https://arxiv.org/abs/2606.10118)
...
### [37] [Radio precursors of monster shocks: a mechanism for fast radio bursts from SGR 1935+2154](https://arxiv.org/abs/2606.10189)
...
### [38] [Constraints on axion-like particles from ultra-high-energy observations of M87 with the HAWC observatory](https://arxiv.org/abs/2606.10292)
...
### [39] [Gamma-Ray Emission from the Crab Pulsar: A 17-Year Fermi-LAT Reanalysis](https://arxiv.org/abs/2606.10519)
...
### [40] [Circular polarization effects induced by photon-axion mixing in astrophysical environments](https://arxiv.org/abs/2606.10527)
...
### [41] [Updating the PATH framework with FRB host galaxy models](https://arxiv.org/abs/2606.10538)
...
### [42] [Discovery of EP J175257.3-351923 as a Candidate Black Hole Low-Mass X-ray Binary](https://arxiv.org/abs/2606.10566)
...
### [43] [Hubble as a Unique Discovery Engine of the Fate of Massive Stars and Black Hole Formation](https://arxiv.org/abs/2606.10710)
...
### [44] [Potential detection of ~ 4.2 keV emission line from GRS 1747-312](https://arxiv.org/abs/2606.10739)
...
### [45] [The Thousand-Pulsar-Array programme on MeerKAT XIX: Single-pulse data analysis, nulling and pulse energy distributions](https://arxiv.org/abs/2606.10807)
...
### [46] [A Multiwavelength Interpretation of HESS J1857+026 Emission Using the Fermi-LAT, VERITAS, and HAWC Observatories](https://arxiv.org/abs/2606.10828)
...
### [47] [Fermi-LAT Gamma-ray Emission Discovered from the Composite Supernova Remnant B0453-685 in the Large Magellanic Cloud](https://arxiv.org/abs/2606.10840)
*Jordan Eagle*
...
### [48] [Pulsar Wind Nebulae (PWNe) -- A Review](https://arxiv.org/abs/2606.10855)
*Jordan Eagle*
...
### [49] [Time lags as proxy of spectral evolution in gamma-ray bursts](https://arxiv.org/abs/2606.10926)
...
### [50] [The link between obscured accretion and mildly relativistic precessing jets](https://arxiv.org/abs/2606.10964)
...
### [51] [Resolving SLX 1744-299 and SLX 1744-300 in the hard X-ray band: implications for their ultracompact nature](https://arxiv.org/abs/2606.11133)
