...
### [13] [Massive scalar fields in eccentric regime: Detectability and constraints from LISA observations of extreme mass-ratio inspirals](https://arxiv.org/abs/2606.27429)
...
### [14] [Critical collapse of vacuum spacetimes: Nakamura wave initial data](https://arxiv.org/abs/2606.27431)
...
### [15] [Tidal Forces in the Presence of Torsion and Nonmetricity](https://arxiv.org/abs/2606.27433)
...
### [16] [Einstein-aether Elliptic Charges and the First Law of Asymptotically AdS Black Holes](https://arxiv.org/abs/2606.27437)
...
### [17] [The crust of dark-matter admixed neutron stars: bulk properties and torsional oscillations](https://arxiv.org/abs/2606.27456)
...
### [18] [Determination of the metric of a Schwarzschild black hole surrounded by a halo of dark matter](https://arxiv.org/abs/2606.27482)
...
### [19] [Dynamics of Relativistic Binaries in Structured and Stochastic Environments: A Lagrange-Fourier-Hansen Framework](https://arxiv.org/abs/2606.27526)
...
### [20] [Geodesic Focusing Conditions in $f(Q)$ Gravity](https://arxiv.org/abs/2606.27532)
...
### [21] [First Demonstration of Optical Feedback Control to Parametric Instability at Advanced LIGO](https://arxiv.org/abs/2606.27643)
...
### [22] [Can a regular black hole be observationally distinguished from singular black holes as spinning lens partner in PSR-BH binaries?](https://arxiv.org/abs/2606.27730)
...
### [23] [A Lagrangian formulation for Rastall gravity and a covariant formulation for unimodular gravity](https://arxiv.org/abs/2606.27761)
...
### [25] [Bounds on the radius of black hole shadows in n-dimensional Einstein gravity](https://arxiv.org/abs/2606.27795)
*Jiaqi Fu,Yong Song*
...
### [26] [New interpretation of the Minkowski limit of $R^2$ gravity](https://arxiv.org/abs/2606.27799)
...
### [27] [Gravitational-wave response functions for space-borne detectors based on multiple geometric time-delay interferometry links](https://arxiv.org/abs/2606.28173)
...
### [28] [Testing generalized spacetimes for black holes using the Hod function representation of the hoop conjecture](https://arxiv.org/abs/2606.27857)
...
### [29] [Quantum fluxes and $\langle\hatΦ^2\rangle$ for a non-minimally coupled scalar field: ringdown and tail on approaching the polar Kerr inner horizon](https://arxiv.org/abs/2606.27859)
...
### [30] [Comparing accretion disk profiles of Bogush-Galt'sov naked singularity and Kerr black hole](https://arxiv.org/abs/2606.27877)
...
### [31] [Superradiant Instability and Two Classes of Scalar Clouds around Kerr-Bertotti-Robinson Black Holes](https://arxiv.org/abs/2606.27958)
...
### [32] [Probing Two Dark Dimensions through Primordial Black Holes, Gravitational Waves, and Colliders](https://arxiv.org/abs/2606.27992)
...
### [33] [Revisit Static Aether: Exact Vacuum Solution in Einstein-Aether Theory and Its Analytic Extension](https://arxiv.org/abs/2606.27995)
*Jie Zhu,Hao Li*
...
### [34] [Joint inference of line-of-sight acceleration and orbital eccentricity in neutron-star--black-hole binaries](https://arxiv.org/abs/2606.28156)
...
### [35] [Finite Coherence in Gravitational Waves from Tidally Excited Axion Clouds](https://arxiv.org/abs/2606.28161)
...
### [36] [Nonlinear stability of subextremal Kerr black holes](https://arxiv.org/abs/2606.28253)
*Peter Hintz*
...
### [37] [Generalizing the interacting dilatonic ghost condensate as a dark energy model](https://arxiv.org/abs/2606.28288)
...
### [38] [Discriminating blazar emission models with high-energy polarimetry: Multi-band predictions and detectability](https://arxiv.org/abs/2606.27417)
...
### [39] [Impact of neutrino-electron scattering and an improved treatment of pair processes on binary neutron star mergers](https://arxiv.org/abs/2606.27425)
...
### [40] [A hidden ultra-relativistic spine in the jet of a neutrino-associated blazar](https://arxiv.org/abs/2606.27430)
...
### [41] [Gamma-ray Bursts in the Radio Sky: the Role of the SKA-VLBI](https://arxiv.org/abs/2606.27434)
...
### [42] [Parsec-scale polarimetry and kinematics of a spine-sheath jet in the neutrino-blazar TXS 0506+056](https://arxiv.org/abs/2606.27435)
...
### [43] [Modelling Dissipative Dynamics of r-mode Instability in Hybrid Stars](https://arxiv.org/abs/2606.27465)
...
### [44] [The Astrophysics of Fast Radio Bursts](https://arxiv.org/abs/2606.27546)
...
### [45] [Exploring the physics behind the observed magnetic filaments in large scale radio galaxies](https://arxiv.org/abs/2606.27591)
...
### [46] [Extreme Mass Ratio Inspirals in Light of Quasi-periodic Eruptions: Milli-Hertz Gravitational Wave Background](https://arxiv.org/abs/2606.27661)
...
### [47] [A Model for Magnetic Reconnection as the Origin of TeV Outbursts from NGC 1275](https://arxiv.org/abs/2606.27680)
...
### [48] [Measuring High-Energy Cosmic Particles with the SKA](https://arxiv.org/abs/2606.28068)
...
### [51] [A statistically robust framework for detecting and classifying hysteresis patterns in astrophysical spectral evolution](https://arxiv.org/abs/2606.28146)
*Tomislav Terzić*
...
### [52] [Shortterm optical variability of 4C 29.45](https://arxiv.org/abs/2606.27820)
*Aykut Özdönmez*
...
### [54] [Mass-Ratio Reversal as an Alternative to Hierarchical Mergers for GW241011](https://arxiv.org/abs/2606.27852)
...
### [55] [A Rare Gamma-ray Flaring episode of the Narrow-Line Seyfert 1 Galaxy 1H 0323+342](https://arxiv.org/abs/2606.28088)
...
### [56] [A Unified Model for the Emission of Supernova-Associated Fast X-ray Transients: Case Studies of EP240414a, EP250108a, and GRB~171205A](https://arxiv.org/abs/2606.28115)
...
### [57] [Science of High Resolution X-ray Imaging](https://arxiv.org/abs/2606.28138)
...
### [58] [Transition from Diffusion to Drift-Dominated Cosmic Ray Transport and the Origin of the Knee](https://arxiv.org/abs/2606.28141)
...
### [59] [SKAO and Gamma-Ray Synergies](https://arxiv.org/abs/2606.28210)
...
### [60] [Numerical model of fast electron energy deposition in interstellar molecular gas](https://arxiv.org/abs/2606.28259)
...
### [61] [Early Optical Follow-up of Gamma-Ray Bursts: The Critical Role of Robotic Telescopes](https://arxiv.org/abs/2606.28267)
...
### [62] [JWST observations support the jittering-jets explosion mechanism (JJEM) for the core-collapse supernova remnant SNR 0540-69.3](https://arxiv.org/abs/2606.28286)
...
### [63] [Accretion-Driven Evolution of Compact-Object Populations in Gas-Rich Environments and the Origin of Massive Gravitational-Wave Sources](https://arxiv.org/abs/2606.28293)
...
### [64] [The impact of stellar binaries and star cluster dynamics on pair-instability supernovae](https://arxiv.org/abs/2606.28299)
...
### [65] [The Role of Scintillation in Detecting HI Absorption in FRB Spectra](https://arxiv.org/abs/2606.28314)
...
### [66] [Continuation of Force-Free Electrodynamics upon the loss of magnetic dominance](https://arxiv.org/abs/2606.28317)
*Morifumi Mizuno*
