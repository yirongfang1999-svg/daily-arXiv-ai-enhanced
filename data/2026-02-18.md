...
### [2] [GW-FALCON: A Novel Feature-Driven Deep Learning Approach for Early Warning Alerts of BNS and NSBH Inspirals in Next-Generation GW Observatories](https://arxiv.org/abs/2602.15073)
...
### [3] [Well-being and career instability across genders in the Spanish Astronomical Society](https://arxiv.org/abs/2602.15085)
...
### [4] [A Response to paper Critical Evaluation of Studies Alleging Evidence for Technosignatures in the POSS1-E Photographic Plates by Watters et al. (2026)](https://arxiv.org/abs/2602.15171)
...
### [5] [GPS constellation search for exotic physics messengers coincident with the binary neutron star merger GW170817](https://arxiv.org/abs/2602.15296)
...
### [6] [Slow focus sensor for the Keck I laser guide star adaptive optics system using focal plane wavefront sensing](https://arxiv.org/abs/2602.15746)
...
### [7] [Deep Learning for Point Spread Function Modeling in Cosmology](https://arxiv.org/abs/2602.15780)
...
### [8] [May Negative Mass Objects exist in the sky?](https://arxiv.org/abs/2602.15058)
...
### [9] [Horizon-Brightened Acceleration Radiation and Optical Signatures of Generic Regular Black Holes from Nonlinear Electrodynamics](https://arxiv.org/abs/2602.15077)
...
### [10] [Black-hole thermodynamics in doubly special relativity: local-frame MDRs and rainbow metrics](https://arxiv.org/abs/2602.15216)
*Abdelmalek Boumali*
...
### [11] [Investigation of the gravitational dust collapse of the LQG-inspired effective asymmetric bounce model](https://arxiv.org/abs/2602.15227)
...
### [12] [Particle production, absorption, scattering, and geodesics in a Schwarzschild--Hernquist black hole](https://arxiv.org/abs/2602.15420)
...
### [13] [Static black holes in an external uniform electromagnetic field: Reissner-Nordstrom accelerating in Bertotti-Robinson](https://arxiv.org/abs/2602.15462)
...
### [14] [A fresh look at boundary terms in Einstein-Hilbert gravity via an initial value variational principle](https://arxiv.org/abs/2602.15469)
...
### [15] [Some phenomenological aspects of a quantum-corrected Reissner-Nordström black hole: quasi-periodic oscillations, scalar perturbations and thermal fluctuations](https://arxiv.org/abs/2602.15551)
...
### [16] [On the Limitations of Karmarkar's Condition in Static, Conformally Flat Spacetimes](https://arxiv.org/abs/2602.15486)
...
### [17] [Displacement memory in regular black hole spacetimes](https://arxiv.org/abs/2602.15523)
...
### [18] [ModMax-AdS Black Hole with Global Monopole as Source in Kalb-Ramond Gravity](https://arxiv.org/abs/2602.15570)
...
### [19] [Periodic orbits and gravitational waveforms of spinning particles in nonlocal Gravity](https://arxiv.org/abs/2602.15609)
...
### [20] [Expansion operators in spherically symmetric loop quantum gravity](https://arxiv.org/abs/2602.15628)
...
### [21] [Timelike bounce hypersurfaces in charged null dust collapse](https://arxiv.org/abs/2602.15786)
*David Bick*
...
### [22] [Resonant Axion-Photon Conversion in the Early Inspiral of Neutron Star Binaries](https://arxiv.org/abs/2602.15065)
...
### [23] [PSR J0024$-$7204ai: a massive, eccentric binary system in the globular cluster 47 Tucanae](https://arxiv.org/abs/2602.15096)
...
### [24] [UV and Optical Signatures of Late-time Disk Instabilities in Tidal Disruption Events](https://arxiv.org/abs/2602.15103)
...
### [25] [Measuring Pulsar Distances from Chirping Orbital Periods](https://arxiv.org/abs/2602.15110)
...
### [26] [Orbital eccentricity can make neutron star g-mode resonances observable with current gravitational-wave detectors](https://arxiv.org/abs/2602.15111)
...
### [27] [Three-Dimensional Kinematics of the Oxygen-rich Supernova Remnant G292.0+1.8](https://arxiv.org/abs/2602.15165)
...
### [28] [Helium superluminous SN 2021bnw : an explosion of a massive star with a pre-outburst](https://arxiv.org/abs/2602.15255)
...
### [29] [Bayesian parameter study of the Seyfert-starburst composite galaxies NGC 1068 and NGC 7469](https://arxiv.org/abs/2602.15644)
